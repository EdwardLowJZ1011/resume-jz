            ...
            <span className="primary-text">
              ...
              {language == "EN" ? (
                <span className="profile-role-tagline">
                  65 certificates (AlgoExpert, Coursera, Udemy), experienced on reactjs, flutter, Django, spark, ML.
                </span>
              ) : (
                <span className="profile-role-tagline">
                  共获得65张技术证书(AlgoExpert, Coursera, Udemy)，具有reactjs, flutter, Django, spark, ML等开发能力。
                </span>
              )}
            </span>
          </div>
