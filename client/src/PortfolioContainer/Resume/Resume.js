...
export default function Resume(props) {
  ...
  const resumeBullets = language == 'EN' ? [
  ...
  const projectDetails =  language == 'EN' ? [
    {
      ...
      description:
        "Build a Fully Functional E-commerce website using MERN Stack, using Redux for state management, stipe to handle our payments, Cloudinary to handle our images, and follow the best practices to implement Authentication & Authorization",
      subHeading: "Technologies Used: React (Frontend), Node.js (Backend runtime environment), Express (Backend Framework), MongoDB (Database), Cloudinary, Stripe",
    },{
      title: "Promax Ecommerce Selling Platform",
      duration: { fromDate: "2021", toDate: "2021" },
      description:
        "Build an eCommerce platform from the ground up with React, Redux, Express & MongoDB",
      subHeading: "Technologies Used: React (Frontend), Node.js (Backend runtime environment), Express (Backend Framework), MongoDB (Database), Paypal",
    },{
  ...
  ] : [
    {
      ...
      subHeading: "使用的技术：React（前端）、Node.js（后端运行环境）、Express（后端框架）、MongoDB（数据库）、Cloudinary、Stripe",
    },{
      title: "Promax电子商务销售平台",
      duration: { fromDate: "2021", toDate: "2021" },
      description:
        "使用 React、Redux、Express 和 MongoDB 从头开始构建电子商务平台",
      subHeading: "使用的技术：React（前端）、Node.js（后端运行环境）、Express（后端框架）、MongoDB（数据库）、Paypal",
    },{
      title: "Carmax电子商务平台",
      duration: { fromDate: "2020", toDate: "2021" },
      description:
  ...
  const resumeDetails = language == 'EN' ? [
    ...
    <div className="resume-screen-container" key="work-experience">
      ...
      <div className="experience-description">
        <span className="resume-description-text">
          Served as departmental IT development Leader. Departmental IT development framework construction and bridge communication between IT and business operations. 
          Using ETL to connect with company DB and build BI dashboard to boost KPI management. 
          Develop RPA tools to replace manual operations, and use React to develop operating systems to improve business efficiency.
        </span>
      </div>

      <div className="experience-description">
        <span className="resume-description-text">
          - Business Analyst, writing proposal and planning the development 
        </span>
        <br />
        <span className="resume-description-text">
    ...
    <div className="resume-screen-container" key="work-experience">
      ...
      <div className="experience-description">
        <span className="resume-description-text">
          担任部门IT开发负责人。 部门IT开发框架搭建，搭建IT与业务运营沟通的桥梁。 
